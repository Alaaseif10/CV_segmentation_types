...
class SpectralThresholding():
    ...
    def localThresholding(self,source: np.ndarray, RegionsX: int, RegionsY: int, ThresholdingFunction):
...
# img = cv.imread('dots2.jpg', cv.IMREAD_GRAYSCALE)

# segmetation = SpectralThresholding()
# local = segmetation.localThresholding(img,5,5,segmetation.doThresholding)
